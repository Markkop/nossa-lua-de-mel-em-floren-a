                  ...
                  <div className="flex flex-wrap justify-center gap-2 sm:gap-3" role="group" aria-label="Senha">
                    {r3.map((char, index) => (
                      <input
                        ...
                        className="h-10 w-10 rounded-md border border-[#3d2b1f]/20 bg-[#fdfbf7] text-center text-xs font-semibold uppercase shadow-sm focus:outline-none focus:ring-2 focus:ring-[#3d2b1f]/30"
                      />
                    ))}
                  </div>
                  {error && (
